    ...
    <div className="lp-root">
      ...
      <div className="lp-page">
        <div className="lp-container">
          ...
          <div className="lp-brand">
            ...
            <p className="lp-brand-sub">ติดตามคำสั่งพิมพ์ฉลากสินค้า</p>
          </div>
      ...
      <style jsx>{`
        ...
        .lp-vignette {
          ...
          background:
            radial-gradient(
              ...
              rgba(77, 143, 224, 0.1) 0%,
              transparent 60%
            ),
            radial-gradient(
              ellipse 70% 60% at 10% 100%,
              rgba(59, 90, 140, 0.16) 0%,
              transparent 65%
            );
          z-index: 1;
        }
        ...
        @media (max-width: 480px) {
          ...
          .lp-body {
            padding: 0.6rem 1.15rem 1.35rem;
          }
          .lp-ticket-foot {
